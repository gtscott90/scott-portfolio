        ...
        <div className="container my-3 p-3 border border border-primary bg-light">
           ...
           <div className="row">
                <div className="col-lg-4">
                    <figure className="text-center"><img src={DevSync} alt="DevSync" style={{width: "250px"}}/> 
                ...
                <div className="col-lg-4">
                    <figure className="text-center"><img src={DestinationGoals} alt="Destination: Goals" style={{width: "250px"}}/> 
                ...
                <div className="col-lg-4">
                    <figure className="text-center"><img src={Spyglass} alt="Spyglass" style={{width: "250px"}}/> 
           ...
           <div className="row">
                <div className="col-lg-4">
                    <figure className="text-center"><img src={DayPlanner} alt="Day Planner Icon" style={{width: "250px"}}/> 
                ...
                <div className="col-lg-4">
                    <figure className="text-center"><img src={EatBurger} alt="Eat Da Burger" style={{width: "250px"}}/> 
                ...
                <div className="col-lg-4">
                    <figure className="text-center"><img src={EmployDir} alt="Employee Directory" style={{width: "250px"}}/> 
            ...
            <div className="row">
                <div className="col-lg-4">
                    <figure className="text-center"><img src={WorkoutTracker} alt="Workout Tracker" style={{width: "250px"}}/> 
                ...
                <div className="col-lg-4">
                    <figure className="text-center"><img src={PassGen} alt="Password Generator" style={{width: "250px"}}/> 
